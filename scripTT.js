...
function changegallerypic(gallery, index) {
	...
	if (orientation=="vertical") {
		...
		$(".prev-holder").css("left", "49px");
		$(".next-holder").css("left", "369px");
		$(".close-holder").css({"left": "393px", "top": "-91px"});
		$("#image-holder").css({"width": "402px", "height": "602px", "position": "absolute", "top": "-101px", "left": "38px"});
	}
	if (orientation=="horizontal") {
		$("#loading-holder").css("left", "251px");
		$(".prev-holder").css("left", "11px");
		$(".next-holder").css("left", "531px");
		$(".close-holder").css({"left": "560px", "top": "11px"});
		$("#image-holder").css({"width": "602px", "height": "400px", "position": "absolute", "top": "0px", "left": "0px"});
	}
	if (orientation=="vertical") {
		if (!vertical) {
			hide("pic");
...
function createMask(currentgallery) {
	...
	$('#perforation-bottom').css({"background-color": "#333", "background-position": "0px -63px"});
	$('.bottomcell').css({"background-color": "#333", "background-position": "0px -63px"});
	$('#perforation-top').css({"background-color": "#333", "background-position": "0px -189px"});
}
...
function restoreMask() {
	...
	$('#perforation-bottom').css({"background-color": "#999", "background-position": "left top"});
	$('.bottomcell').css({"background-color": "#999", "background-position": "left top"});
	$('#perforation-top').css({"background-color": "#999", "background-position": "0px -126px"});
}
...
function positionNavigationIcons() {
		...
		$(".next-holder").css("left", left - 69 + "px");
		$(".close-holder").css("left", left - 45 + "px");
...
$(document).ready(function() {
	...
	$('.close-holder').hide();
	$('.next-holder').hide();
	$('.prev-holder').click(function(event) {
		hideNavigationIcons(0, 0);
	});
	$('.next-holder').click(function(event) {
		hideNavigationIcons(0, 0);
	});	
	...
	$('#film').mouseenter(function(event) {
		hideNavigationIcons(0, 'fast');
	});
	$('#perforation-top').mouseenter(function(event) {
		hideNavigationIcons(0, 'fast');
	});
	$('#perforation-bottom').mouseenter(function(event) {
		hideNavigationIcons(0, 'fast');
	});
	$('.ttclick').mouseenter(function(event) {
		hideNavigationIcons(0, 'fast');
	});
